...
-->
    ...
    <body>
        <audio src="music/5.mp3" autoplay="autopaly"></audio>
            ...
            <div id="wrap">
                <div id="text">
			        <div id="code">
			        	...
			        	<span class="say">// 在某一天，你我相遇。</span><br>
						<span class="say"> </span><br>
                        <span class="say">// 不经意相识，或许是缘分，或许是注定的。</span><br>
						<span class="say"> </span><br>
			        	<span class="say">// 以后不管怎么样，我都会在你身边。</span><br>
						<span class="say"> </span><br>
			        	<span class="say">// 就算全世界都抛弃你，记得还有我。</span><br>
						<span class="say"> </span><br>
						...
						<span class="say"> </span><br>					
                        <span class="say"><span class="space"></span> ----李家明</span>
			        </div>
                </div>
                <div id="clock-box">
    ...
    (function(){
        ...
        var textAnimate = eval(Jscex.compile("async", function () {
		    ...
		    together.setFullYear(year, month, date); 			//时间年(四位整数)月(0~11)日(1~31)
